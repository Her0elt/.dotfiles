local user_plugins = {
	...
	-- Telescope
	{
		...
		config = function()
			require("her0elt.plugins.configs.telescope")
		end,
	},
	...
	-- Whichkey
	{
		...
		config = function()
			require("her0elt.plugins.configs.which-key")
		end,
	},
	...
	-- LSP
	{
		...
		config = function()
			...
			require("mason").setup()
			require("her0elt.plugins.configs.lspconfig")
		end,
	},
	...
	-- Autocompletion and Snippets
	{
		...
		config = function()
			require("her0elt.plugins.configs.cmp")
		end,
	},
	...
	-- Treesitter
	{
		...
		config = function()
			require("her0elt.plugins.configs.treesitter")
		end,
	},
	...
	},
	{
		...
		requires = "nvim-tree/nvim-web-devicons",
		config = function()
			require("her0elt.plugins.configs.lualine")
		end,
	},
